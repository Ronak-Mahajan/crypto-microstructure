...
ofi/bars.py         1 s bars, close-before-apply, gap flags, no fabricated bars
...
tests/              136 offline tests, incl. the synthetic fixture and its generator
